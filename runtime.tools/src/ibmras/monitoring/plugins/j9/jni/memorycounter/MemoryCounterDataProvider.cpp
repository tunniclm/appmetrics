...
char* getMemoryCounters(JNIEnv *env) {
	...
	categories_buffer =
			(jvmtiMemoryCategory*) ibmras::monitoring::plugins::j9::jni::hc_alloc(
	...
	memcounterarray = (char**) ibmras::monitoring::plugins::j9::jni::hc_alloc(
	...
	ibmras::common::memory::deallocate((unsigned char**)&catName);
		...
		memcounterarray[i] =
				(char *) ibmras::monitoring::plugins::j9::jni::hc_alloc(
						strlen(buffer) + 1);
	...
	cleanup: ibmras::monitoring::plugins::j9::jni::hc_dealloc(
			(unsigned char**) &category_name);
	ibmras::monitoring::plugins::j9::jni::hc_dealloc(
			(unsigned char**) &categories_buffer);
	ibmras::monitoring::plugins::j9::jni::dealloc_report_lines(memcounterarray,
			written_count);
	ibmras::monitoring::plugins::j9::jni::hc_dealloc(
