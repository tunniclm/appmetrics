...
#ifndef ibmras_monitoring_plugins_j9_jni_jnireceiver_h
#define ibmras_monitoring_plugins_j9_jni_jnireceiver_h
...
#endif /* ibmras_monitoring_plugins_j9_jni_jnireceiver_h */
