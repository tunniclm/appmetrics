...
#elif defined(LINUX) || defined(RS6000) || defined(J9ZOS390) /* MVS */
...
#define TOC_UNWRAP_ADDRESS(wrappedPointer) (((J9FunctionDescriptor_T *)(uintptr_t)(wrappedPointer))->rawFnAddress)
