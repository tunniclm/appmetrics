 ...
 */
omr_error_t omr_trc_startup(OMR_VM *omrVM, const OMRTraceLanguageInterface *languageIntf,
 ...
 *
 * @pre The current thread must be attached to j9thread.
