...
LINK=link.exe
LINK_OPT=/DEBUG
LD_OPT=./healthcenter.res
HC_EXPORT=-DEXPORT
CFLAGS=/FA /Zi /Fd -D_WINDOWS /DEBUG -DWINDOWS -D_64BIT -D__LITTLE_ENDIAN /EHsc -c /MD ${HC_EXPORT} -DWIN64 -DIBMRAS_DEBUG_LOGGING
RC_COMPILE=rc /v /Fohealthcenter.res healthcenter.rc
