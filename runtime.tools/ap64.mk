...
CFLAGS=-O -D__BIG_ENDIAN -D_AIX -DAIX -DAIXPPC -D_64BIT -G -qasm_as=/usr/bin/as -q64 -qasm=gcc -DREVERSED -c -DIBMRAS_DEBUG_LOGGING -D__NOLOCK_ON_INPUT -D__NOLOCK_ON_OUTPUT
LIB_EXT=so
EXE_EXT=
LIBFLAGS=-G -q64 -G
LIB_OBJOPT=-o"$@"
