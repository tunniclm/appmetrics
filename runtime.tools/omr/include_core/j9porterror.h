 ...
 * @{
 */
#define J9PORT_ERROR_SYSV_IPC_FTOK_ERROR (-2<<16)
#define J9PORT_ERROR_SYSV_IPC_SEMGET_ERROR (-3<<16)
#define J9PORT_ERROR_SYSV_IPC_SEMCTL_ERROR (-4<<16)
#define J9PORT_ERROR_SYSV_IPC_SEMOP_ERROR (-5<<16)
#define J9PORT_ERROR_SYSV_IPC_SHMGET_ERROR (-6<<16)
#define J9PORT_ERROR_SYSV_IPC_SHMCTL_ERROR (-7<<16)
#define J9PORT_ERROR_SYSV_IPC_SHMAT_ERROR (-8<<16)
#define J9PORT_ERROR_SYSV_IPC_SHMDT_ERROR (-9<<16)
#define J9PORT_ERROR_SYSV_IPC_GETIPC_ERROR (-10<<16)
