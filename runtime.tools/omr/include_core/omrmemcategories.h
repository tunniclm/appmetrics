...
#define J9MEM_OMR_CATEGORY_INDEX_FROM_CODE(code) (((U_32)0x7FFFFFFF) & (code))
...
#define J9MEM_CATEGORY_1_CHILD(description, code, c1) static U_32 _j9mem_##code##_child_categories[] = {c1}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 1, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_2_CHILDREN(description, code, c1, c2) static U_32 _j9mem_##code##_child_categories[] = {c1, c2}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 2, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_3_CHILDREN(description, code, c1, c2, c3) static U_32 _j9mem_##code##_child_categories[] = {c1, c2, c3}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 3, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_4_CHILDREN(description, code, c1, c2, c3, c4) static U_32 _j9mem_##code##_child_categories[] = {c1, c2, c3, c4}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 4, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_5_CHILDREN(description, code, c1, c2, c3, c4, c5) static U_32 _j9mem_##code##_child_categories[] = {c1, c2, c3, c4, c5}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 5, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_6_CHILDREN(description, code, c1, c2, c3, c4, c5, c6) static U_32 _j9mem_##code##_child_categories[] = {c1, c2, c3, c4, c5, c6}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 6, _j9mem_##code##_child_categories}
#define J9MEM_CATEGORY_7_CHILDREN(description, code, c1, c2, c3, c4, c5, c6, c7) static U_32 _j9mem_##code##_child_categories[] = {c1, c2, c3, c4, c5, c6, c7}; static J9MemCategory _j9mem_category_##code = {description, code, 0, 0, 0, 0, 7, _j9mem_##code##_child_categories}
